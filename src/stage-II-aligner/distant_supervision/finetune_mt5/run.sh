...
PYTHON=/home$(which python)   #change required
...
# execute training
$PYTHON $MODEL_DIR/main.py --dataset_path $DATASET_DIR --epochs $EPOCHS --lang $LANG --gpus $GPUS --batch_size $BATCH_SIZE --max_seq_len $MAX_SEQ_LENGTH --checkpoint_path $CHECKPOINT_PATH --learning_rate $LR --model_name $MODEL_NAME --online_mode $ONLINE_SYNC --use_pretrained $PRETRAINED
